...
let s:N2   = [ '#ffffff' , '#444444' , 154  , 238 ]
...
" Now using.
"let s:IA1 = [ '#4e4e4e' , '#1c1c1c' , 247, 232 , '' ]
"let s:IA2 = [ '#4e4e4e' , '#262626' , 247, 234 , '' ]
"let s:IA3 = [ '#4e4e4e' , '#303030' , 247, 236 , '' ]
let s:IA1 = [ '#4e4e4e' , '#1c1c1c' , 232, 243 , '' ]
let s:IA2 = [ '#4e4e4e' , '#262626' , 250, 234 , '' ]
let s:IA3 = [ '#4e4e4e' , '#303030' , 232, 243 , '' ]
